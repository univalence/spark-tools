...
object Builder {
  ...
  def build2[A[_], In, Out](in: A[In])(implicit f: Functor[A], gen: LabelledGeneric.Aux[Out, In]): A[Out] = f.map(in)(gen.from)
...
object Test {
  ...
  assertTypedEquals[Option[FieldType[namek,String]] :: HNil](Builder.transFormField.apply('name ->> Option("hello")) :: HNil)
